...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__RoverPositionSetpoint__rosidl_typesupport_introspection_c__RoverPositionSetpoint_message_member_array[4] = {
  {
    "timestamp",  // name
